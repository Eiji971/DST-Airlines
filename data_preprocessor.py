...
df = pd.read_csv('./data/flight_statusTot2023-07-06.csv')
df.head()
...
# Save preprocessed data arrays to CSV files
np.savetxt('./data/preprocessedcsv/X_train_preprocessed.csv', X_train_preprocessed, delimiter=',')
np.savetxt('./data/preprocessedcsv/y_train_encoded.csv', y_train_encoded, delimiter=',')
np.savetxt('./data/preprocessedcsv/X_test_preprocessed.csv', X_test_preprocessed, delimiter=',')
np.savetxt('./data/preprocessedcsv/y_test_encoded.csv', y_test_encoded, delimiter=',')
